...
public class ATM_Deposit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Bath.setText("฿");
        Bath.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 255), 2));

        des2.setFont(new Font("Tahoma", 1, 18)); // NOI18N
        des2.setHorizontalAlignment(SwingConstants.CENTER);
        des2.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 204), 2));
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(des2, GroupLayout.PREFERRED_SIZE, 276, GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(69, 69, 69)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(des2, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logInButtonging.logInButtonger.getlogInButtonger(ATM_Deposit.class.getName()).logInButton(java.util.logInButtonging.Level.SEVERE, null, ex);
